...
<MetaResultFile version="20211011" creator="FD-Control">
  ...
  <SimulationProperties fieldname="loss (f=5) [1]" frequency="5" encoded_unit="&amp;U:W^1.:m^-2" quantity="surf_loss_density" fieldtype="Surface power loss dens." fieldscaling="UNDEFINED" dB_Amplitude="10"/>
